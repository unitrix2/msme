...
const App = (() => {
  ...
  let theme = localStorage.getItem('pdf-tool-theme-v2') || 'dark';
  let accent = localStorage.getItem('pdf-tool-accent-v2') || 'red';
  ...
  function applyTheme(t) {
    ...
    localStorage.setItem('pdf-tool-theme-v2', t);
  ...
  function applyAccent(color) {
    ...
    localStorage.setItem('pdf-tool-accent-v2', color);
